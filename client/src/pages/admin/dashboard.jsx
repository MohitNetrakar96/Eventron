...
function AdminDashboard() {
    ...
    const fetchAllEvents = async () => {
        try {
            ...
            // First try to get all events (same as user dashboard)
            ...
            console.log('Events from all events endpoint:');
            ...
            // Use all events data directly
            setAllEvents(allEventsData);
            
            // Log the first few events for debugging
            if (allEventsData.length > 0) {
                console.log('First few events being displayed:');
                allEventsData.slice(0, 3).forEach((event, index) => {
                            ...
                            <div className="p-4 overflow-y-auto w-full h-[calc(80vh)]">
                                <div className="flex justify-between items-center mb-4">
                                    ...
                                    <div className="flex space-x-2">
                                        <button
                                            onClick={() => router.push('/admin/past_events')}
