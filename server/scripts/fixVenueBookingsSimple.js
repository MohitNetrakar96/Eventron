/**
 * Simple script to fix venue bookings
 */
...
mongoose.connect(process.env.MONGO_URI || 'mongodb+srv://anandpatoli:anand12345@cluster0.q7jkuzy.mongodb.net/?retryWrites=true&w=majority')
  .then(() => {
...
async function fixVenueBookings() {
  try {
    ...
    console.log(`Stats: Processed ${events.length} events, updated ${updatedVenues} venues, added ${totalBookingsAdded} bookings`);
